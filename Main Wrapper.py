"""
    Reasons to choose this code:
    I developed Python programs for quantum matrial researches when I worked at Joint Quantum Instute at University of Maryland.
    The programs are designed to communicate with multimeters and voltage/current sources, dynamically visualize data, automatically save as well as analyze data.
    I also designed user-friendly interfaces by Qt Designer for lab users who did not have a programming background.
    The programs contain multiple code files as well as the UI part. This file contains the main functions of the program.
    The whole program was designed and written by myself, with help and inspiration by Johnathon Vannucci.
    Abundant comments were added helping readers or other programmers to quickly understand the code.
"""
